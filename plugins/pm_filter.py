...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me/Itz_Sahil_official')
        ]
    )
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/Chat_Official_Sahil'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/Itz_Sahil_Official')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ Sahil ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🖤 𝓾𝓹𝓭𝓪𝓽𝓮𝓼 🖤', url='https://t.me/Itz_Sahil_Official'),
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/+oGLA6aKxY8VlZGM1')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/TamilanBotsZ_Support'),
            InlineKeyboardButton('💌 SERIES ✨', url='https://t.me/+kSmEY46pt7NmYTJl'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('❤️‍🔥 ᴏᴡɴᴇʀ 😊', url='https://t.me/Itz_Sahil_Official'),
            InlineKeyboardButton('🤍 Support', url='https://t.me/TheSupportOfficial'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://t.me/Sahil_X_Official'), #Please Change your bot username
